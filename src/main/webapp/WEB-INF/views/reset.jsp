...
<body>
	...
	<form action="/reset" method="post" style="width: 230px; background-color: #fafafb; border: 2px dashed #DDD; padding: 30px; padding-bottom: 50px; margin-top: 100px">
		...
		<div style="text-align: center; font-size: 16px; display: table; margin-top: 10px">	
			...
			<div style="width: 100%; text-align: center; font-size: 16px; display: table; margin-top: 10px">	
				<button type="submit" class="button" style="width: 100%; background-color: #5fba7d; border: 1px solid #5fba7d">Reset</button>
			</div>	
		</div>
